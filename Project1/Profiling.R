...
df <- read.csv("D:/Universitat/OPTATIVAS/MD/First project/code/speeddatingCleaned.csv", sep=",", encoding="UTF-8", na.strings = c("NA"))
numericalVariablesPosition <- c(3,8,9,10,14,15,16,17,18,19,20,21,22)
categoricalVariablesPosition <- c(5,6,7,11,12,13)
names(df[numericalVariablesPosition])
names(df[categoricalVariablesPosition])
...
#num filas en dades y num de cols en pvalk
